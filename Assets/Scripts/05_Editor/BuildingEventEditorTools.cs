...
{
    // =====================================================================
    // 05_Editor/BuildingEventDatabaseEditor.cs
    // =====================================================================
    ...
    public class BuildingEventDatabaseEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Validate Event Database"))
            {
                ...
                {
                    Debug.Log(
                        "[BuildingEventDatabase] 검증 완료: 오류 없음",
                        database);
                }
                else
                {
    ...
    // =====================================================================
    // 05_Editor/BuildingEventExampleCreator.cs
    // =====================================================================
    ...
    public static class BuildingEventExampleCreator
    {
        ...
        public static void CreateExamples()
        {
            ...
            BuildingEventVariantSOBJ pharmacy = CreateVariant(
                Root + "/VAR_LockedSpace_Pharmacy.asset",
                "VAR_LOCKED_SPACE_PHARMACY",
                locked,
                "Pharmacy",
                "잠긴 의약품 보관실",
                "매장 뒤편의 철제 보관실은 아직 잠겨 있다. " +
                "안쪽에는 쓸 만한 의약품이 남아 있을 가능성이 높다.",
                "MEDICINE");

            BuildingEventVariantSOBJ police = CreateVariant(
                Root + "/VAR_LockedSpace_Police.asset",
                "VAR_LOCKED_SPACE_POLICE",
                locked,
                "PoliceStation",
                "봉인된 증거물 보관실",
                "봉인 테이프 너머로 잠긴 증거물 보관실이 보인다. " +
                "무기나 탄약이 남아 있을 수 있다.",
                "AMMO");

            BuildingEventVariantSOBJ garage = CreateVariant(
                Root + "/VAR_LockedSpace_Garage.asset",
                "VAR_LOCKED_SPACE_GARAGE",
                locked,
                "Garage",
                "잠긴 부품 창고",
                "정비소 안쪽의 부품 창고가 굳게 잠겨 있다. " +
                "차량 수리용 부품과 공구가 남아 있을 수 있다.",
                "VEHICLE_PART");
        ...
        private static BuildingEventChoiceData CreateToolChoice()
        {
            ...
            choice.requiredItems.Add(
                new BuildingEventItemRequirement
                {
                    itemId = "TOOLKIT",
                    amount = 1
                });
            ...
            choice.pushFailureAdditional.effects.Add(
                new BuildingEventEffectData
                {
            ...
            choice.criticalFailureAdditional.effects.Add(
                new BuildingEventEffectData
                {
            ...
            BuildingEventArchetypeSOBJ item)
        {
            ...
            item.defaultResult.effects.Add(
                new BuildingEventEffectData
                {
            ...
            string rewardItemId)
        {
            ...
            item.normalSuccess.effects.Add(
                new BuildingEventEffectData
                {
